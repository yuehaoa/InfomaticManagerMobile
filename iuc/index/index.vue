<template>
	<view class="flex flex-direction padding">
		...
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="goCreate">列表页面（失效）</a>
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="go('44213f8a-c90a-422b-88c0-815f4de5a000','softwareInstall')">以管理员身份登录（失效）</a>
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="go('d9824e8c-c998-45e2-8156-34d723049855','softwareInstall')">以普通老师身份登录（失效）</a>
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="go('8094cf84-01e6-484d-bb01-04a299f5ef5b','softwareInstall')">以维修者主管身份登录（失效）</a>
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="go('b15f7cdb-9f96-4041-a7b2-4cfeebabaa8d','softwareInstall')">以普通维修者身份登录（失效）</a>
	</view>
</template>
