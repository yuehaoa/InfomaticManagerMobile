<template>
	<view class="flex flex-direction padding">
		...
		<a href="javascript:;" class="cu-btn bg-green lg margin-top" @click="go('44213f8a-c90a-422b-88c0-815f4de5a000','softwareInstall')">以管理员身份登录</a>
		...
		<a href="javascript:;" class="cu-btn bg-blue lg margin-top" @click="goRoomDetail()">到实验室详细页面</a>
	</view>
</template>
...
<script>
	...
	export default {
		methods: {
			goRoomDetail () {
				uni.navigateTo({
					url: "/iuc/roomApplication/v1/roomDetail"
				})
			},
			go (id,where) {
